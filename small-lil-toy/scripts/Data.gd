...
const wave_content_level_1 = {
	"wave_1": [0, 1, 3.0, 1, 3.0, 1, 3.0, 1, 3.0, 1, 2.5, 1, 2.0, 1, 1.0, 1, 1.0, 1],
	"wave_2": [0, 2, 3.0, 1, 3.0, 1, 3.0, 2, 3.0, 2, 3.0, 2, 3.0, 1, 1.0, 1, 1.0, 2],
	"wave_3": [0, 2, 2.0, 2, 2.0, 2, 2.0, 1, 1.0, 2, 2.0, 2, 1.0, 1, 1.0, 2, 1.0, 2],
	"wave_4": [0, 3, 3.0, 2, 2.0, 1, 1.0, 3, 2.0, 3, 2.0, 2, 2.0, 3, 1.5, 3, 1.5, 1],
	"wave_5": [0, 3, 1.5, 3, 1.5, 3, 1.5, 1, 1.0, 1, 1.0, 1, 1.0, 2, 1.0, 3, 1.0, 2, 1.0, 3, 1.0, 3, 1.0, 2, 1.0, 1],
	"wave_6": [0, 4, 3.0, 4, 2.5, 4, 2.0, 3, 1.0, 2, 1.0, 2, 1.0, 3, 1.0, 2, 1.0, 3, 1.0, 1, 1.0, 1, 1.0, 3, 1.0, 4],
	"wave_7": [0, 4, 2.0, 4, 1.5, 4, 1.0, 3, 0.5, 3, 1.0, 3, 1.0, 2, 1.0, 2, 1.0, 3, 1.0, 2, 1.0, 4, 1.0, 3, 1.8, 4],
	"wave_8": [0, 5, 3.0, 5, 2.5, 5, 2.0, 4, 1.0, 4, 1.0, 5, 2.0, 5, 2.0, 3, 1.0, 4, 1.0, 2, 1.0, 2, 1.0, 5, 4, 2.0, 5, 1.0, 5, 1.0, 2],
	"wave_9": [0, 5, 2.0, 5, 1.5, 5, 1.3, 5, 1.3, 5, 1.3, 5, 4, 1.3, 5, 4, 1.3, 3, 1.3, 3, 1.3, 5, 4, 1.3, 5, 3, 1.3, 3, 1.0, 5, 1.3, 4],
	"wave_10":[0, 6, 3.0, 6, 2.5, 6, 2.0, 5, 1.3, 5, 1.8, 5, 6, 2.5, 5, 4, 1.8, 5, 4, 1.8, 5, 1.3, 4, 1.0, 4, 1.3, 4],
	"wave_11":[0, 6, 2.2, 6, 2.2, 6, 2.2, 5, 4, 2.2, 5, 4, 2.2, 5, 4, 2.2, 6, 5, 2.2, 6, 5, 2.2, 4, 6, 2.2, 3],
	"wave_12":[0, 7, 3.0, 7, 2.5, 7, 2.0, 6, 2.0, 7, 1.5, 5, 7, 2.0, 5, 6, 2.5, 5, 4, 1.5, 5, 3, 1.5, 7, 1.5, 6, 3.5, 4, 1.0, 3, 1.0, 7],
	"wave_13":[0, 7, 2.0, 7, 2.0, 7, 2.0, 6, 5, 2.0, 6, 7, 1.5, 7, 5, 1.5, 5, 6, 2.5, 7, 2.5, 6, 7, 2.5, 6, 7, 2.5, 7, 2.5, 7, 3.0, 5, 6, 1.5, 6, 5],
	"wave_14":[0, 8, 4.0, 8, 4.0, 8, 4.0, 8, 4.0, 8, 4.0, 7, 2.5, 7, 2.5, 6, 5, 2.5, 7, 2.5, 8, 4.0, 5, 7, 2.5, 6, 2.5, 8, 4.0, 5, 6, 2.5, 6, 7],
	"wave_15":[0, 8, 4.0, 8, 4.0, 8, 4.0, 8, 4.0, 6, 2.5, 6, 2.5, 6, 2.5, 6, 2.5, 5, 0.5, 5, 0.5, 5, 0.5, 5, 10.0, 9]
}
